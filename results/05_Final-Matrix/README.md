...
| rel_pwm | The PWM score of the CTCF motif relative to the maximum score possible under the PWM. |
| rel_pval | Statistical signficance of the observed score under rel_pwm. |
| mid_strand | Strand of the CTCF motif match. |
| rDHS | The accession code of the position's intersecting rDHS.  |
| zscore_meta | The meta-analyzed activity score of the rDHS, without masking scores. |
| zscore_meta_masked | The meta-analyzed activity score of the rDHS after masking scores of -10, which correspond to rDHS with raw signal scores of 0. |
...
| ref_pwm_pval_log10 | Signficance of atSNP's REF allele PWM score.  |
| alt_pwm_pval_log10 | Signficance of atSNP's ALT allele PWM score. |
